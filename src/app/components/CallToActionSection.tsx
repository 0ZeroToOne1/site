...
const CallToActionSection: FC = () => {
  return (
    <motion.section
      id="contact"
      className="relative bg-[#030b1a] text-white px-6 py-24 pb-4 text-center overflow-hidden"
    ...
    >
      ...
      >
        <a
          ...
          className="inline-flex items-center justify-center gap-2 rounded-md bg-[var(--accent)] px-6 py-3 text-white text-sm font-medium shadow-md transition-transform duration-200 ease-out hover:-translate-y-0.5 hover:bg-[var(--accent-hover)] hover:shadow-lg"
        >
