...
import { Eye, Zap, Handshake } from 'lucide-react';
...
const ThreePillars: FC = () => {
  return (
    <section className="bg-white px-6 py-24">
      ...
      <div className="grid max-w-5xl mx-auto grid-cols-1 sm:grid-cols-3 gap-16 text-center">
...
<motion.div
  ...
  transition={{
    ...
    repeatType: 'loop',
    ease: 'easeInOut',
    delay: i * 0.2, // staggered pulse if desired
  }}
>
