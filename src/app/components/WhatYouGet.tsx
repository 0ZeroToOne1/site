...
<section className="px-6 py-20 sm:py-24 bg-gradient-to-t from-blue-50 to-white " id="what-you-get">
        <div className="mx-auto max-w-6xl text-center">
        <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8 sm:mb-12 tracking-tight">What You Get</h2>

        <div className="grid max-w-5xl mx-auto text-center sm:grid-cols-3 gap-12 sm:gap-16 px-4">
            {items.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 line-clamp-3 leading-relaxed">{item.text}</p>
                </motion.div>
              );
            })}
          </div>
