...
const HowWeWorkTimeline: FC = () => {
  ...
  useEffect(() => {
    ...
    currentStepRefs.forEach((el) => el && observer.observe(el));
    return () => {
  ...
  return (
    <MotionSection id="how-we-work" className="relative px-6 py-20 sm:py-24 -mt-30 z-10 bg-[radial-gradient(ellipse_at_center,_rgba(255,255,255,0.5)_30%,_transparent_100%)] ">
